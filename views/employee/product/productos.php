...
<a href="?controller=producto&method=edit&id_producto=<?= $producto->id_producto ?>">
<button class="btn btn-success py-2 px-3">Editar</button>

<a href="?controller=producto&method=delete&id_producto=<?= $producto->id_producto ?>">
...
<form action="?controller=producto&method=store" method="POST"  enctype="multipart/form-data">
