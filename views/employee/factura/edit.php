      ...
      <div class="text-left col-md-6">
        ...
        <p>Ingresaste a la zona de edicion de productos, aca podras editar la cantidad precio u otras opciones dentro del producto</p> 
          ...
          <div class="col-md-6 align-self-center">   
            ...
            <form action="?controller=factura&method=update" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input name="producto" type="text" class="form-control" id=producto required  value="<?= $factura->producto ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
