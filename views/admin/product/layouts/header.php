...
<html lang="en">
  <head>
    ...
    <!--Fonts-->
    <link href="https://fonts.googleapis.com/css?family=Flower|Oswald|Righteous&display=swap" rel="stylesheet">
    <!-- Font Awesome -->
    ...
    <link rel="stylesheet"  type="text/css" href="assets/tables/datatables/DataTables-1.10.18/css/dataTables.bootstrap4.min.css">
